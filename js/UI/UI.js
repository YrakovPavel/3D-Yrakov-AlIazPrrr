class UI {
    constructor({ callbacks = {} }){
        ...
        const printShadows = (callbacks.printShadows instanceof Function) ? callbacks.printShadows : function(){};
        ...
        document.getElementById('printShadows').addEventListener('click', function(){ printShadows(this.checked)});
    }
